      ...
      <LayoutField>
        <div className="z-10 flex flex-col w-full gap-8 px-10 py-14">
          ...
          <div className="flex w-1/2 gap-4">
            <button
              className="w-1/4 text-[#5A5A5A] py-2 text-xl  font-semibold tracking-wider rounded-lg bg-[#CCCCCC]/50 dark:bg-[#444444]/50 dark:text-[#DBDBDB] opacity-80 hover:opacity-100"
              onClick={() => setFieldNumber(1)}
            >
              Kembali
            </button>
            <button className="w-3/4 text-[#FCFCFC] text-xl font-semibold tracking-wider rounded-lg bg-[#2E7BEF] py-2 opacity-90 hover:opacity-100 ">
              Lanjut
            </button>
          </div>
        </div>
