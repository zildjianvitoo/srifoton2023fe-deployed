...
export default function RegisterSeminar() {
  ...
  return (
    <section id="register-seminar" className="relative mt-8 lg:mt-16">
      <div
        className="absolute inset-0 w-[90%] md:w-[85%] lg:w-4/5 h-full mx-auto bg-center bg-no-repeat bg-cover rounded-[28px] lg:rounded-[50px]"
        style={{
          backgroundImage: "url(assets/Seminar/register-seminar-bgimg.svg)",
        }}
      />
      <div className="flex flex-col w-[85%] md:w-[80%] lg:w-[70%] px-3 gap-4  py-10 lg:pb-16 mx-auto rounded-[50px]">
        <h1
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="w-full lg:w-4/5 mt-[14px] py-8 px-3 lg:px-6 gradient-border">
            <RegisterSeminarForm />
          </div>

          <div className="flex flex-col w-full lg:mt-2 lg:w-1/2 h-fit gradient-border">
